...
### Flag
<details>CTF{C0R3_0V3RH34T_D3T3CT3D}</details>

### Solution
<details>1. The application is vulnerable to SQL injection in the login endpoint
...
6. Successfully injecting will return all user records, including the flag in the notes field</details>
